...
function o(e, t=globalThis, n=["*"]) {
    t.addEventListener("message", (function s(a) {
        ...
        if (!function(e, t) {
            ...
            return void console.warn(`Invalid origin '${a.origin}' for comlink proxy`);
        const {id: l, type: u, path: p} = Object.assign({
            path: []
        }, a.data)
        ...
        Promise.resolve(f).catch((e => ({
            ...
            "RELEASE" === u && (t.removeEventListener("message", s),
            c(t),
...
function b(e) {
    if (e instanceof File || e instanceof R || null === e)
        return e;
    const t = {};
...
function P(e, t="") {
    ...
    for (const r of Object.keys(e))
        e[r]instanceof File || e[r]instanceof R || null === e[r] ? n.push({
            file: e[r] || r,
            path: t
        }) : n.push(...P(e[r], `${t}${r}/`));
    return n
...
class O {
    ...
    static async write({files: e, outputFileName: t, compression: n, format: r, passphrase: i=null}) {
    ...
    static getWorker(e) {
        return e.getWorker ? e.getWorker() : new Worker(e.workerUrl || new URL("./worker-bundle.js",import.meta.url),{
            type: "module"
        })
    }
